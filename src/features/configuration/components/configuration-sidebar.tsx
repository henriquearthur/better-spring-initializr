...
type ConfigurationSidebarProps = {
  ...
  onResetConfig: () => void
  showReset: boolean
  metadataDrivenOptions: MetadataDrivenConfigOptions
...
export function ConfigurationSidebar({
  ...
  return (
    <div className="space-y-4">
      ...
      <MetadataStatusBanner message={metadataStatusMessage} />
...
function MetadataStatusBanner({ message }: { message?: string }) {
  if (!message) {
    return null
  }
